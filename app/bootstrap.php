...
function provision_tenant_db(string $path,array $tenant): void {
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS corporate_customers(id INTEGER PRIMARY KEY AUTOINCREMENT,corp_code TEXT UNIQUE,company_name TEXT NOT NULL,contact_person TEXT NOT NULL DEFAULT '',phone TEXT NOT NULL DEFAULT '',email TEXT NOT NULL DEFAULT '',address TEXT NOT NULL DEFAULT '',npwp TEXT NOT NULL DEFAULT '',notes TEXT NOT NULL DEFAULT '',is_active INTEGER NOT NULL DEFAULT 1,created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)");
    $cols=tenant_db_columns($pdo,'corporate_customers');
    foreach(['corp_code'=>"TEXT",'contact_person'=>"TEXT NOT NULL DEFAULT ''",'phone'=>"TEXT NOT NULL DEFAULT ''",'email'=>"TEXT NOT NULL DEFAULT ''",'address'=>"TEXT NOT NULL DEFAULT ''",'npwp'=>"TEXT NOT NULL DEFAULT ''",'notes'=>"TEXT NOT NULL DEFAULT ''",'is_active'=>"INTEGER NOT NULL DEFAULT 1",'updated_at'=>"TEXT NOT NULL DEFAULT ''"] as $col=>$def){ if(!isset($cols[$col])) $pdo->exec("ALTER TABLE corporate_customers ADD COLUMN $col $def"); }
    $pdo->exec("CREATE TABLE IF NOT EXISTS corporate_invoices(id INTEGER PRIMARY KEY AUTOINCREMENT,invoice_code TEXT UNIQUE,corporate_id INTEGER NOT NULL,invoice_month TEXT NOT NULL,title TEXT NOT NULL DEFAULT '',description TEXT NOT NULL DEFAULT '',amount INTEGER NOT NULL DEFAULT 0,original_amount INTEGER NOT NULL DEFAULT 0,discount_amount INTEGER NOT NULL DEFAULT 0,discount_note TEXT NOT NULL DEFAULT '',paid_amount INTEGER NOT NULL DEFAULT 0,balance_amount INTEGER NOT NULL DEFAULT 0,due_date TEXT NOT NULL DEFAULT '',status TEXT NOT NULL DEFAULT 'unpaid',paid_at TEXT NOT NULL DEFAULT '',payment_method TEXT NOT NULL DEFAULT '',notes TEXT NOT NULL DEFAULT '',created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)");
    $cols=tenant_db_columns($pdo,'corporate_invoices');
    foreach(['title'=>"TEXT NOT NULL DEFAULT ''",'description'=>"TEXT NOT NULL DEFAULT ''",'original_amount'=>"INTEGER NOT NULL DEFAULT 0",'discount_amount'=>"INTEGER NOT NULL DEFAULT 0",'discount_note'=>"TEXT NOT NULL DEFAULT ''",'paid_amount'=>"INTEGER NOT NULL DEFAULT 0",'balance_amount'=>"INTEGER NOT NULL DEFAULT 0",'due_date'=>"TEXT NOT NULL DEFAULT ''",'paid_at'=>"TEXT NOT NULL DEFAULT ''",'payment_method'=>"TEXT NOT NULL DEFAULT ''",'notes'=>"TEXT NOT NULL DEFAULT ''",'updated_at'=>"TEXT NOT NULL DEFAULT ''"] as $col=>$def){ if(!isset($cols[$col])) $pdo->exec("ALTER TABLE corporate_invoices ADD COLUMN $col $def"); }
    $pdo->exec("CREATE INDEX IF NOT EXISTS idx_tenant_corporate_invoices_month ON corporate_invoices(invoice_month,status)");
...
function tenant_corporate_code(): string { return 'CORP'.date('ymd').random_int(100,999); }
function tenant_corporate_invoice_code(int $corpId,string $month): string { return 'CORP-INV-'.str_pad((string)$corpId,4,'0',STR_PAD_LEFT).'-'.str_replace('-','',$month).'-'.random_int(10,99); }
